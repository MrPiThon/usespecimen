...
**Budget.** 6 colours, 5 more for its dark scheme, 6 radii, 10 spacing steps,
...
rounding them into a tidy 8px rhythm. Its canvas carries no pattern or wash,
so leave it flat. An absence here is an instruction rather than a gap: fill
nothing in from convention.
